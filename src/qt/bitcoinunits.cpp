...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EOC");
    case mBTC: return QString("mEOC");
    case uBTC: return QString::fromUtf8("μEOC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("EiniaOraCoins"));
    case mBTC: return QString(QObject::tr("Milli-EiniaOraCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-EiniaOraCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
