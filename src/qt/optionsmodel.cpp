...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/EiniaOraCoin/tx/%s|https://coinplorer.com/EOC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/EOC/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/EiniaOraCoin/tx/%s|https://coinplorer.com/EOC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/EOC/tx/%s").toString();
