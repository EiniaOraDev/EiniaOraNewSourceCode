...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EiniaOraCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"37.59.18.108", "37.59.18.108"},
	{"86.97.250.141", "86.97.250.141"},
	{"66.102.133.15", "66.102.133.15"},
    {"EiniaOraCoin1.karelia.pro", "dnsseed1.EiniaOraCoin.karelia.pro"},
    {"EiniaOraCoin1.ru", "dnsseed1.EiniaOraCoin.ru"},
    {"EiniaOraCoin1.ru", "testseed1.EiniaOraCoin.ru"},
    {"novaco1.in", "dnsseed1.novaco.in"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EiniaOraCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("EiniaOraCoin-start");
