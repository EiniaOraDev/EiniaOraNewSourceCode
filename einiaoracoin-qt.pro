TEMPLATE = app
TARGET = EiniaOraCoin-qt
VERSION = 1.1.0
INCLUDEPATH += src src/json src/qt
QT += core gui network printsupport
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE USE_IPV6 BOOST_SPIRIT_THREADSAFE BOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN __NO_SYSTEM_INCLUDES __STDC_FORMAT_MACROS
DEFINES += STATIC
#DEFINES += Q_MOC_RUN
...
#win32:LIBS += -lboost_chrono$$BOOST_LIB_SUFFIX -Wl,-Bstatic -lpthread -Wl,-Bdynamic
